...
ASCOTT_GIT_CLEAN_COLOR="%{$fg[green]%}"
ASCOTT_GIT_DIRTY_COLOR="%{$fg[red]%}"
ZSH_THEME_GIT_PROMPT_PREFIX=" %{$fg[red]%}["
ZSH_THEME_GIT_PROMPT_SUFFIX="%{$fg[red]%}]%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_CLEAN=" $ASCOTT_GIT_CLEAN_COLOR✔"
ZSH_THEME_GIT_PROMPT_DIRTY=" $ASCOTT_GIT_DIRTY_COLOR±"